 ...
 * License: MIT
 *
 * Generated at 2017-05-23 11:31:53 +0200
 */
(function() {
'use strict';
 ...
 */
tagsInput.directive('autoComplete', ["$document", "$timeout", "$sce", "$q", "tagsInputConfig", "tiUtil", "$window", function($document, $timeout, $sce, $q, tagsInputConfig, tiUtil, $window) {
...
tagsInput.run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put('ngTagsInput/auto-complete.html',
    "<div class=\"autocomplete\" ng-if=\"suggestionList.visible\"><ul class=\"suggestion-list\"><li class=\"suggestion-item\" ng-repeat=\"item in suggestionList.items track by track(item)\" ng-class=\"getSuggestionClass(item, $index)\" ng-click=\"addSuggestionByIndex($index)\" ng-mouseenter=\"suggestionList.select($index)\"><ti-autocomplete-match scope=\"templateScope\" data=\"::item\"></ti-autocomplete-match></li><li class=\"suggestion-bottom\"></li></ul></div>"
  );
